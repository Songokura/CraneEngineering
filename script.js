...
const I18N = {
  kk: {
    ...
    'comp.i7': 'Муфталар', 'comp.i8': 'Кран кабиналары',
    ...
    'w3': 'Нысандағы траверса', 'w4': 'Бағанадағы консольді кран',
    'w5': 'Жөнелту алдындағы грейфер', 'w6': 'Ойығы кесілген арқан барабандары',
    'w7': 'Мойынтіректі торабы бар барабан', 'w8': 'Дәнекерленген металл конструкциялар',
    'w9': 'Кран дөңгелектерінің партиясы', 'w10': 'Жартылай мосы кран',
    'w11': 'Жиналған кран арбашасы', 'w12': 'Кран басқару кабинасы',
    'w13': 'Нысандағы металл конструкциялар', 'w14': 'Арқан блоктары бар полиспаст',
